		...
		try {
			if (cursor != null && cursor.moveToFirst()) {
				...
				do {
					...
					student.setBirthday(mDateFormat.parse(cursor
							.getString(idxBirthday)));
